...
function CartDetails() {
  ...
  return (
    <section className="px-6 pt-10 pb-20 md:py-20 lg:pt-20 lg:pb-36 text-pureWhite text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <tr className="text-xs md:text-base">
                    ...
                    <td className="py-4">
                      <div className="flex items-center justify-center">
                        <input
                          type="number"
                          className="w-full max-w-[50px] outline-none bg-transparent [&::-webkit-inner-spin-button]:appearance-none text-center"
                          value={cartValue}
              ...
              <div className="flex items-center gap-6 text-sm md:text-base font-medium">
                <div className="flex-1">
                  <input
                    ...
                    className="w-full py-4 px-6 bg-navySemi rounded-full"
                  />
                </div>
          ...
          <div className="capitalize text-pureWhite bg-navySemi rounded-3xl p-6 flex flex-col gap-8 text-base">
            ...
            <div className="">
              <Link
                to="/checkout"
                className="text-blackFadeDark block bg-primaryColor md:font-bold w-full px-6 py-4 rounded-full"
              >
                Proceed to CheckOut
              </Link>
            </div>
