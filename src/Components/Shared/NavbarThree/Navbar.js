...
function Navbar() {
  ...
  return (
    <nav className="py-6 lg:py-8 px-6 text-navyDark absolute top-4 lg:top-10 xl:top-8 left-4 right-4 md:left-12 xl:left-16 md:right-12 xl:right-16  bg-pureWhite rounded-full font-medium uppercase">
      ...
      <div
        className={`flex flex-col md:flex-row md:items-center md:justify-between  fixed right-0 top-0 bottom-0 gap-6 md:gap-0 md:relative bg-whiteLow md:bg-transparent overflow-auto md:overflow-visible  duration-300 z-50 ${
      ...
      >
        ...
        <div className="px-8 md:p-0">
          <ul className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            <li className="relative group">
              <p
                className={
                  "flex items-center hover:bg-whiteSemi md:hover:bg-transparent px-6 py-2 md:p-0 rounded-md hover:text-primaryColor cursor-pointer group"
                }
              ...
              <ul
                className={`md:bg-whiteLow  rounded-lg static md:absolute z-20 md:invisible md:opacity-0 md:translate-y-4 md:group-hover:visible md:group-hover:opacity-100 md:group-hover:translate-y-0 duration-300 overflow-hidden ${
            ...
            <li className="relative group">
              <p
                className="flex items-center px-6 py-2 md:p-0 rounded-md hover:text-primaryColor hover:bg-whiteSemi md:hover:bg-transparent cursor-pointer group"
            ...
            <li>
              <NavLink
                to="/station"
                className="flex px-6 py-2 md:p-0 rounded-md hover:text-primaryColor hover:bg-whiteSemi md:hover:bg-transparent "
              >
                satation
              </NavLink>
            </li>
        ...
        <div className="px-8 md:p-0">
          <ul className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            <li className="relative group">
              <p
                className="flex items-center hover:text-primaryColor cursor-pointer group px-6 py-2 md:p-0 rounded-md hover:bg-whiteSemi md:hover:bg-transparent"
