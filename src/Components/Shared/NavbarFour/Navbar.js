...
function Navbar() {
  ...
  return (
    <nav className="py-6 lg:py-8 px-6 bg-navyDark absolute top-4 lg:top-10 xl:top-8 left-4 right-4 md:left-12 xl:left-16 md:right-12 xl:right-16  text-pureWhite font-medium uppercase rounded-full">
