...
function Navbar() {
  ...
  return (
    <nav className="p-6 lg:px-8 xl:py-10 xl:px-16 z-50 bg-navyDark absolute top-4 lg:top-10 xl:top-8 left-4 right-4 md:left-12 xl:left-16 md:right-12 xl:right-16 ">
