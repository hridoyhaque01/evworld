...
function Banner() {
  return (
    <section className="text-pureWhite bg-bannerTwo bg-no-repeat bg-bottom bg-cover object-contain flex items-center px-16 pt-32 pb-14 md:pt-64 md:pb-36 xl:pb-56 md:pl-28">
