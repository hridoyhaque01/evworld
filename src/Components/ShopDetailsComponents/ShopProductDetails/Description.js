...
function Description() {
  return (
    <section className="px-6 pt-10 md:pt-20 lg:pt-36 text-pureWhite">
      <div className="max-w-[1180px] mx-auto">
        <div class="border-b border-b-blackFadeDark pb-6">
          <nav class="flex gap-6" aria-label="Tabs" role="tablist">
            <button
              type="button"
              class="text-2xl font-normal hs-tab-active:font-bold hs-tab-active:text-primaryColor active"
            ...
            <button
              type="button"
              class="text-2xl font-normal hs-tab-active:font-semibold hs-tab-active:text-primaryColor"
          ...
          <div id="tabs-with-underline-1" role="tabpanel">
            <div>
              ...
              <ul className="list-disc pl-4">
                <li>
                  Instant torque from electric motor for quick acceleration
                </li>
                <li>
              ...
              <ul className="list-disc pl-4">
                ...
                <li>
                  Quieter and smoother driving experience with no engine noise
                  or vibration
                </li>
              ...
              <p>
                Experience the future of driving with the EVX1 - the electric
                car designed for a better tomorrow.
              </p>
            </div>
          </div>
