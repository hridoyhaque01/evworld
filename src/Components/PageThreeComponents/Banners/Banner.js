...
function Banner() {
  return (
    <section className="text-pureWhite bg-bannerOne bg-no-repeat bg-bottom bg-cover object-contain flex items-center px-6 justify-center pt-32 pb-14 md:pt-64 md:pb-36">
