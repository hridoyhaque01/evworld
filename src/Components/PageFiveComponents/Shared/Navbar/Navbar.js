...
import { logoBlack } from "../../../../Assets/getImages";
...
function Navbar() {
  ...
  return (
    <nav className="p-6 lg:px-8 xl:py-10 xl:px-16 z-50 bg-primaryColor text-blackFadeDark">
        ...
        >
          ...
          <ul className="flex flex-col md:items-center justify-start md:flex-row gap-6 md:gap-4 lg:gap-6">
            <li className="">
              <Link
                to="/"
                className="flex  py-2 pl-4 hover:bg-navyDark md:py-0 md:pl-0 md:hover:bg-transparent uppercase font-medium rounded-md duration-100"
              >
                Home
              </Link>
            </li>
            <li className="group relative">
              <p
                className="group flex items-center  py-2 pl-4 hover:bg-navyDark md:py-0 md:pl-0 md:hover:bg-transparent uppercase font-medium rounded-md duration-100 cursor-pointer "
