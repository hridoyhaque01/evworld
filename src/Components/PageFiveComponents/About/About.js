  ...
  return (
    <section className="px-6">
      <div className="max-w-[1180px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mt-6 md:mt-20 lg:mt-36 gap-6 items-center">
          ...
          <div className="order-1 md:order-2 text-center md:text-right">
            <h2 className="font-clashBold text-2xl md:text-5xl text-primaryColor">
              About Us
            </h2>
            <p className="text-pureWhite mt-4">
              Our company is dedicated to creating a cleaner and more
              sustainable future through electric mobility. We manufacture
              electric vehicles, charging stations and chargers, home charging
              setups, car body parts, and a charging station located
              app/software. Our mission is to provide eco-friendly solutions
              that promote sustainability and efficiency, while delivering an
              exciting driving experience for our customers.
            </p>
          </div>
        </div>
      </div>
